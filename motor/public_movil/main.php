    ...
    <div id="divreservas">
            ...
            ?>
                ...
                <div id="capaViajo">
                    ...
                    <div id="d_vehiculo" class="caja">
                        <?= $textosTraducidos["label_tipo_vehiculo"] ?><br />
                        <div id="divvehiculo">
                    ...
                    <div id="d_marca" class="caja">
                        <?= $textosTraducidos["label_marca"] ?><br />
                    ...
                    <div id="d_modelo" class="caja">
                        <?= $textosTraducidos["label_modelo"] ?><br />
        ...
        <div id="divocupacion">
            ...
            <div class="form-check form-switch form-switch-md">
                ...
                <label class="form-check-label" for="switchFamilia"><?= $textosTraducidos["label_familia"] ?></label>
            </div>
            ...
            <div id="divfamilia" class="caja">
                ...
                <select name="famnum" id="familia" class="form-select">
                    <option value="general"><?= $textosTraducidos["label_fn_general"] ?></option>
                    <option value="especial"><?= $textosTraducidos["label_fn_especial"] ?></option>
                </select>
            </div>

            <button type="button" id="aceptarocu"><?= $textosTraducidos["label_aceptar"] ?></button>
